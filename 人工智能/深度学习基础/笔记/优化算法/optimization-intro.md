...
```
![svg](imgs/optimization-intro_files/optimization-intro_5_0.svg)
## 深度学习中的优化挑战
...
```
![svg](imgs/optimization-intro_files/optimization-intro_7_0.svg)
...
```
![svg](imgs/optimization-intro_files/optimization-intro_9_0.svg)
...
d2l.plt.ylabel('y');
```
![svg](imgs/optimization-intro_files/optimization-intro_11_0.svg)
...
```
![svg](imgs/optimization-intro_files/optimization-intro_13_0.svg)
