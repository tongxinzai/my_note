<div align="center">
  ![](resources/mmyolo-logo.png" width="600"/>
  <div>&nbsp;</div>
  <div align="center">
...
![](https://user-images.githubusercontent.com/45811724/190993591-bd3f1f11-1c30-4b93-b5f4-05c9ff64ff7f.gif"/>
<details open>
...
![](https://user-images.githubusercontent.com/27466624/199999337-0544a4cb-3cbd-4f3e-be26-bcd9e74db7ff.jpg)
...
- 算法解读
  ...
  - [算法原理和实现全解析](https://mmyolo.readthedocs.io/zh_CN/latest/algorithm_descriptions/index.html#算法原理和实现全解析)
    - [YOLOv5 原理和实现全解析](yolov5_description.md)
    - [RTMDet 原理和实现全解析](rtmdet_description.md)
- 用户指南
